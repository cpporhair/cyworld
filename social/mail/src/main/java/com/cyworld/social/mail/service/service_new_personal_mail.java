...
@Component
public class service_new_personal_mail {
    private static final Logger logger = LoggerFactory.getLogger(service_new_personal_mail.class.getName());
    @Autowired
        ...
        return request.bodyToMono(req_new_personal_mail.class)
                ...
                .flatMap(c -> {
                    return WebClient.create()
                            .post()
                            .uri("http://" + this_conext.instance.host + "/mail/v1/sendto")
