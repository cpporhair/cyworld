...
import com.cyworld.social.utils.request.friend.req_top_friend;
...
@Component
public class service_top_friend {
    @Builder
    ...
    public Mono serv(ServerRequest request) {
        context this_conext = context
                ...
                .build();
        return request.bodyToMono(req_top_friend.class)
                .doOnNext(body -> {
                ...
                .flatMap(body -> {
                    return WebClient.create()
                            .post()
                            .uri("http://" + this_conext.instance.host + "/friend/v1/top_friend")
