...
public class service_invite {
    ...
    public Mono serv(ServerRequest request) {
        ...
        return request.bodyToMono(req_friends_invite.class)
                ...
                .flatMap(body -> {
                    if(body.getFrom_id().equals(body.getTarget_id())&&body.getFrom_namespace().equals(body.getTarget_namespace()))
                        return Mono.error(new Throwable("cant invite youself"));
                    return WebClient.create()
                            .post()
                            .uri("http://" + this_conext.instance.host + "/friend/v1/invite")
