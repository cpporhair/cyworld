...
@Configuration
public class Coordinator_service_manager {
    ...
    @Data
    @Builder
    public static class coordinator_service_instance {
    ...
    public static Cache<String, coordinator_service_instance> cached_instance = Caffeine.newBuilder()
                    ...
                    Flux.fromIterable(((NamingEvent) e).getInstances())
                            .flatMap(i -> {
                                return Flux.fromArray(i.getMetadata().get("dataKey").split(";"))
                                        .map(s -> coordinator_service_instance
                                                .builder()
                                                .db_name(s)
